...
describe('Toolbar item', () => {
    ...
    it('is an element with the toolbar-item tag name', () => {
        ...
        let toolbarItem: ToolbarItem = new ToolbarItem();
        // expect
    ...
    describe.skip('can have a label', () => { // requires applicationContext mocking
        ...
        describe('as plain text', () => {
            ...
            it('with text only', () => {
                ...
                // when
                let toolbarItem: ToolbarItem = new ToolbarItem();
                toolbarItem.setCommandManager(commandManager);
                toolbarItem.setIconManager(iconManager);
                toolbarItem.setDefinition(toolbarItemDefinition);
                // then
