...
class CpuModule extends Module {
    ...
    buidMenuEntries(menu: Menu): void {
        ...
        menu.popup('app:main-menu.debug.label')
            ...
            .item({id: 'debug-terminateall', label: 'app:main-menu.debug.terminate-all', handler: () => this.onDebugTerminateAll()})
            ...
            .separator()
            .item({id: 'debug-togglebreakpoint', label: 'app:main-menu.debug.toggle-breakpoint', handler: () => this.onDebugToggleBreakpoint(), shortcut: 'F9'})
